...
struct sherwood_v8_constants
{
    ...
    static constexpr size_t jump_distances[num_jump_distances]
    {
        ...
        1614000520, 3631437253, static_cast<size_t>(8170829695),
        static_cast<size_t>(18384318876), static_cast<size_t>(41364501751),
        static_cast<size_t>(93070021080), static_cast<size_t>(209407709220),
        static_cast<size_t>(471167588430), static_cast<size_t>(1060127437995),
        static_cast<size_t>(2385287281530),
        static_cast<size_t>(5366895564381), static_cast<size_t>(12075513791265),
        static_cast<size_t>(27169907873235), static_cast<size_t>(61132301007778),
        static_cast<size_t>(137547673121001), static_cast<size_t>(309482258302503),
        static_cast<size_t>(696335090510256), static_cast<size_t>(1566753939653640),
        static_cast<size_t>(3525196427195653), static_cast<size_t>(7931691866727775),
        static_cast<size_t>(17846306747368716), static_cast<size_t>(40154190394120111),
        static_cast<size_t>(90346928493040500), static_cast<size_t>(203280588949935750),
        static_cast<size_t>(457381324898247375), static_cast<size_t>(1029107980662394500),
        static_cast<size_t>(2315492957028380766),static_cast<size_t>(5209859150892887590),
    };
};
template<typename T>
